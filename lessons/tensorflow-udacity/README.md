This is a local copy of the folder https://github.com/tensorflow/tensorflow/blob/master/tensorflow/examples/udacity/ to work on the Deep Learning Udacity course assignments.
